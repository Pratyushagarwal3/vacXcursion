				...
				<div class="container">
					...
					<div class="w3ls-header-right">
						<ul> 
							...
							<li class="head-dpdn">
							<i class="fa fa"aria-hidden="true">Welcome <?php echo " ".$wel;?></i>
							...
							echo "<a href='$linkkk'><i class='fa fa' aria-hidden='true'>$lu</i></a>";
						...
						<div class="flip-container">
							<div class="flipper agile-products">
								...
								<div class="back">
									...
									<a href="customized.php?did=<?php echo $b[0][$k][1];?>&pid=<?php echo $b[0][$k][0];?>&price=<?php echo $b[0][$k][5];?>">Customize</a>
